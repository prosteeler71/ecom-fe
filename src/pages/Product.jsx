...
const Product = () => {
  ...
  useEffect(() => {
    fetch(`https://average-bathing-suit-foal.cyclic.cloud/products/${id}`)
  ...
  return (
    <section className="dark:text-gray-400 text-black h-auto min-h-screen dark:bg-gray-900 body-font overflow-hidden">
